 ...
 */
package pl.net.maxi.business.mails.restful.service;
...
import pl.net.maxi.business.mails.entity.ProductCode;
 ...
 */
@Stateless
@Path("pl.net.maxi.business.mails.restful.productcode")
